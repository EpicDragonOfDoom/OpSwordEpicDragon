...
namespace OpSwordEpicDragon.Items
{
	...
	public class WaterSword : ModItem
	{
		...
		{
			DisplayName.SetDefault("Water Sword"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
