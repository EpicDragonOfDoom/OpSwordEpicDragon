...
{	
	public class MonetizationProjectile : ModProjectile 
	{
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Monetization");
        }
		public override void SetDefaults()
		{
			projectile.width = 1000; //Set the hitbox width
			projectile.height = 1000; //Set the hitbox height
        ...
        public override void Kill(int timeLeft)
        {
            ...
            if(rand == 0)
            {
                Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, mod.ItemType("InfiniteCoin"), 50, false, 0, false); //Spawns a bullet
            }
        }
	}
}
