...
{	
	public class DemonetizationProjectile : ModProjectile 
	{
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Demonetization");
        }
		public override void SetDefaults()
		{
			projectile.width = 500; //Set the hitbox width
			projectile.height = 500; //Set the hitbox height
        ...
        public override void Kill(int timeLeft)
        {
            ...
            if(rand == 0)
            {
                Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, mod.ItemType("Demonitization"), 1, false, 0, false); //Spawns a bullet
            }
        }
	}
}
