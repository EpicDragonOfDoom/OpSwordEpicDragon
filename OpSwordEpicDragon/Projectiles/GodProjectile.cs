...
{	
	public class GodProjectile : ModProjectile 
	{
        ...
        {
            DisplayName.SetDefault("God Projectile");
        }
		public override void SetDefaults()
		{
			...
			projectile.penetrate = 9999; //Tells the game how many enemies it can hit before being destroyed
        ...
        public override void Kill(int timeLeft)
        {
            ...
            if(rand == 0)
            {
                Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, mod.ItemType("GodProjectile"), 1, false, 0, false); //Spawns a bullet
            }
        }
	}
}
